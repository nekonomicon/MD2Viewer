# simple Makefile for Quake 2 Model Viewer
...
ifneq (, $(findstring mingw, $(SYS)))
LIBS += -lcomctl32 -lcomdlg32 -lgdi32 -lopengl32 -lglu32 -lwinmm -static-libgcc -static-libstdc++
else
CFLAGS += -fPIC
LIBS += $(shell pkg-config --libs Qt5OpenGL gl glu)
INCLUDE += $(shell pkg-config --cflags Qt5OpenGL gl glu)
endif
